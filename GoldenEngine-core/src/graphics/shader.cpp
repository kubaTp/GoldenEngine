...
namespace golden {
	namespace graphics {
		...
		Shader::Shader(const char* vertPath, const char* fragPath) : m_VertPath(vertPath), m_FragPath(fragPath), m_Name("empty") { m_ShaderID = load(); }
		Shader::Shader(std::string vertPath, std::string fragPath) : m_VertPath(vertPath), m_FragPath(fragPath), m_Name("empty") { m_ShaderID = load(); }
		Shader::Shader(std::string name, std::string vertPath, std::string fragPath) : m_VertPath(vertPath), m_FragPath(fragPath), m_Name(name) { m_ShaderID = load(); }
